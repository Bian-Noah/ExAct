"""LangChain 版 ActionTool + target_pos 正则解析。

提供 parse_target_pos 函数和 LCActionTool（langchain_core.tools.BaseTool 子类）。
"""
...
class LCActionTool(BaseTool):
    ...
    def _run(self, instruction: str) -> str:
        ...
        """
        import logging
        _log = logging.getLogger("lc_action")
